<x-app-layout>
    <div class="w-full flex justify-center py-10">
        <div class="max-w-7xl bg-background p-10">
            <h1 class="text-3xl font-bold mb-6">Dagelijkse Uitdaging</h1>
            ...
            <div class="relative text-white p-6 px-0">
                <div class="bg-gradient-lap rounded-md shadow-md w-full h-5/6">
                    ...
                    <p class="w-1/2 p-6">
                        In een <strong>dystopische toekomst</strong> zou het verdwijnen van de vliegenzwam laten zien hoe
                ...
                <img src="https://picsum.photos/600/400"
                     ...
                     class="absolute right-0 top-0 w-1/2 h-full object-cover rounded-md shadow-md">
            </div>
            ...
            <div class="mb-6">
                    <p class="inline-block text-lg py-3">Welke kleine gewoonte helpt indirect mee aan het behoud van soorten zoals de vliegenzwam?</p>
            </div>

            <form class="mt-8" action="#" method="post">
                @csrf
                <fieldset>
                    <legend class="text-lg font-medium mb-4">Antwoordopties</legend>
